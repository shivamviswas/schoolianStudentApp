...
import com.example.abhishekbaari.schoolian3.model.Animes;
...
public class RecyclerViewAdapterUser extends RecyclerView.Adapter<RecyclerViewAdapterUser.MyViewHolder> {
    ...
    //String URL_PRODUCTS="http://schooli.000webhostapp.com/android/getStar.php";
    int status=1,star=1,getStatus;
    String postId,valueOfstar;
    private List<Animes> lstAnime ;


    public RecyclerViewAdapterUser(Context mContext, List<Animes> mData) {
    ...
    public void changeDataSet(List<Animes> mData) {
        this.mData = mData;
    }
